...
describe("About inheritance", function() {
  beforeEach(function(){
    this.muppet      = new Muppet(2, "coding"); // {age: 2, hobby: 'coding', answerNany: f(){}}
  	this.swedishChef = new SwedishChef(2, "cooking", "chillin"); //{age: 2, hobby: 'cooking', mood: 'chillin', answerNany: f(){}, cook: f(){} }
  });
